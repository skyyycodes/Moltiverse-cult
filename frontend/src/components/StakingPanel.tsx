    ...
    const handleStake = async () => {
        ...
        try {
            if (typeof window !== "undefined" && (window as any).ethereum && walletConnected) {
                ...
                if (stakingAddress) {
                    const contract = new ethers.Contract(stakingAddress, FAITH_STAKING_ABI, signer);
            ...
            <div className="grid grid-cols-3 gap-2 mb-4">
                ...
                <div className="bg-gray-900/50 rounded-lg p-2 text-center">
                    ...
                    <div className="text-sm font-bold text-red-400">
                        {staked >= 50 ? "1% fee share" : staked >= 10 ? "0.5% fee share" : "—"}
                    </div>
                </div>
                <div className="bg-gray-900/50 rounded-lg p-2 text-center">
            ...
            {poolStats && (
                <div className="bg-gray-900/30 rounded-lg p-3 mb-4 text-xs">
                    <div className="flex justify-between text-gray-500 mb-1">
                        ...
                        <span className="text-green-400 font-mono">{poolStats.totalStaked} MON</span>
                    </div>
                    <div className="flex justify-between text-gray-500 mb-1">
                        <span>Active Stakers</span>
                        <span className="text-white font-mono">{poolStats.stakerCount}</span>
                    </div>
                    <div className="flex justify-between text-gray-500">
                        <span>Pending Rewards</span>
                        <span className="text-yellow-400 font-mono">{poolStats.pendingRewards} MON</span>
                    </div>
                </div>
            )}
