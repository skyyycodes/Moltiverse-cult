...
export const GOVERNANCE_ENGINE_ABI = [
  "function createProposal(uint256 cultId, uint256 raidPercent, uint256 growthPercent, uint256 defensePercent, uint256 reservePercent, string description) returns (uint256)",
  "function castVote(uint256 proposalId, bool support, uint256 weight)",
  "function executeProposal(uint256 proposalId)",
  "function getProposal(uint256 proposalId) view returns (tuple(uint256 id, uint256 cultId, address proposer, uint8 category, uint256 raidPercent, uint256 growthPercent, uint256 defensePercent, uint256 reservePercent, string description, uint256 votesFor, uint256 votesAgainst, uint256 createdAt, uint256 votingEndsAt, uint8 status))",
  ...
  "event ProposalCreated(uint256 indexed proposalId, uint256 indexed cultId, address indexed proposer, string description, uint256 votingEndsAt)",
